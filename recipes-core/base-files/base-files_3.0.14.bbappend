...
do_install_append () {
    ...
    ln -s /boot/imx8mm-verdin-wifi-moducop-cpu01.dtb ${D}/boot/imx8mm-verdin-wifi-dev.dtb
    ln -s /boot/imx8mp-verdin-wifi-moducop-cpu01.dtb ${D}/boot/imx8mp-verdin-wifi-dev.dtb
}